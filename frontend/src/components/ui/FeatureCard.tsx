...
export function FeatureCard({ description, number, title }: FeatureCardProps) {
  return (
    <article className="min-h-feature border-r border-line px-feature-x first-of-type:pl-0 first-of-type:pr-feature-x max-phone:min-h-0 max-phone:border-b max-phone:border-r-0 max-phone:px-0 max-phone:py-feature-mobile-y max-phone:first-of-type:pt-0">
